/**
 * One-time: `sets/` → `images/sets/` (logos and symbols uploaded with uploadSeededImagesToR2).
 *
 * Usage:
 *   DRY_RUN=1 npx tsx scripts/r2MoveSetsUnderImages.ts
 *   npx tsx scripts/r2MoveSetsUnderImages.ts
 */
