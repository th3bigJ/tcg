...
# under a prefix (default: images/pokemon/), so the app only needs R2_BUCKET=tcg and one public URL.
#
...
#   DEST_PREFIX=images/pokemon SOURCE_BUCKET=pokemon DEST_BUCKET=tcg ./scripts/r2-migrate-pokemon-bucket-into-tcg.sh
#
...
DEST_PREFIX="${DEST_PREFIX:-images/pokemon}"
ENDPOINT="${ENDPOINT:-}"
